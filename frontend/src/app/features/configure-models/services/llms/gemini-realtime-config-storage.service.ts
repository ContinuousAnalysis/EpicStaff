...
export class GeminiRealtimeConfigStorageService {
    private readonly api = inject(GeminiRealtimeConfigService);

    private configsRequest$?: Observable<GeminiRealtimeConfig[]>;
    private configsSignal = signal<GeminiRealtimeConfig[]>([]);
    ...
    getAllConfigs(forceRefresh = false): Observable<GeminiRealtimeConfig[]> {
    ...
    createConfig(data: CreateGeminiRealtimeConfigRequest): Observable<GeminiRealtimeConfig> {
    ...
    updateConfig(data: UpdateGeminiRealtimeConfigRequest): Observable<GeminiRealtimeConfig> {
