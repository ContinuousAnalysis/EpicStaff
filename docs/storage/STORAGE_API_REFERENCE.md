...
- Rejects password-protected archives, zip-slip members and symlinked members
- Rejects an archive whose contents expand past `DJANGO_MAX_ARCHIVE_UNCOMPRESSED_SIZE`
